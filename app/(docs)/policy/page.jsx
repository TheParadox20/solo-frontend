      ...
      <div className="w-screen bg-primary-dark pt-5">
        ...
        <div className="top-20 -left-56 mb-10 w-full max-w-xs rounded-lg bg-[#103E47] text-white px-6 py-3 mt-2 shadow-md lg:absolute lg:w-56 lg:top-20" style={{ borderRadius: '17px' }}>
            ...
            <div className="mt-4">
              ...
              <div className="relative mb-3">
                <a
                  className={`block mb-1 text-md font-bold text-white p-1 ${currentSection === 'section-eight' ? 'border-l-4 border-primary-light' : 'hover:text-primary-light hover:border-l-4 hover:border-primary-light'} transition duration-300 ease-in-out`}
                  href="#section-eight"
                >
                  Contact Us
                </a>
          ...
          <article className="text-LightGray">
            ...
            <h2 id="section-eight" className="mb-4 text-3xl text-primary-light font-bold">
              Contact Us
            </h2>
            <p className="mb-10 text-LightGray">
