    ...
    <footer className="border-t-[1px] border-Grey px-4 py-4 mt-8">
      <div className="flex flex-col md:flex-row gap-y-6 justify-between py-6">
        <div className="md:w-1/4">
          ...
          <Link className="bg-primary-light block w-fit py-2 md:py-4 px-8 rounded-lg font-semibold lg:mt-8" href={'/register'}>
            Join Now
          </Link>
        </div>
      ...
      <div className="flex flex-col-reverse gap-y-2 md:flex-row justify-between border-t-[1px] border-Grey pt-4 pb-8 md:py-8">
        ...
        <div className="flex gap-6 mx-auto md:mx-0">
          <a href="http://" target="_blank" rel="noopener noreferrer">
            <div className="w-7 h-7 icon-[hugeicons--new-twitter-rectangle]" />
          </a>
          <a href="http://" target="_blank" rel="noopener noreferrer">
            <div className="w-7 h-7 icon-[hugeicons--linkedin-01]" />
          </a>
          <a href="http://" target="_blank" rel="noopener noreferrer">
            <div className="w-7 h-7 icon-[hugeicons--instagram]" />
          </a>
          <a href="http://" target="_blank" rel="noopener noreferrer">
            <div className="w-7 h-7 icon-[hugeicons--facebook-01]" />
          </a>
        </div>
      </div>
    </footer>
