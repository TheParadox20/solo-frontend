...
function Welcome() {
  return (
    <div className="bg-[url('/Hero_bg.jpeg')] rounded-lg relative z-20 mb-8">
      ...
      <Image
        className="absolute w-2/5 md:w-1/3 lg:w-[37%] 2xl:w-[30%] -z-10 right-0 bottom-0"
        src="/man_celebrating.png"
        alt="Man Celebrating"
        width={500} // Adjust the width and height as necessary
        height={500} // Adjust the width and height as necessary
      />
    </div>
  );
}
  ...
  return (
    <div className="bg-[url('/banking_bg.jpg')] rounded-lg relative z-20 mb-8">
      <div className="z-10 bg-black/50 p-4">
        <h2 className="text-3xl font-bold">Instant Deposits and Withdrawals</h2>
        <p className="my-3 w-3/4 md:w-1/2">
