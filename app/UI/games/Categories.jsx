...
export default function Categories({categories, path}){
    ...
    return(
        <>
        <button className="text-xl 2xl:text-2xl 2xl:my-5 font-bold flex items-center w-fit justify-between gap-4 relative" onClick={e=>toggle('categoriesDropDown')}>{path.length>1?path[path.length-1]:'All'} <span className="icon-[ep--arrow-down] w-6 h-6"/></button>
